...
@section('isi')
    ...
    <main id="main" class="main">
        @if (Session('level') == 2)
            <div class="pagetitle">
                <h1>Konfirmasi Masuk</h1>
                <nav>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="index.html">Menu</a></li>
                        <li class="breadcrumb-item active">Konfirmasi Masuk</li>
                    </ol>
                </nav>
            </div><!-- End Page Title -->
            <section class="section">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">Konfirmasi Masuk</h5>
                        ...
                        @endforeach --}}
                                    {{-- </tbody> --}}
                                    <tbody>
                                        @foreach ($konfirmasikepala as $index => $item)
                                            <tr>
                                                <th scope="row">{{ $index + $konfirmasikepala->firstItem() }}</th>
                                                <td>{{ $item->file_pdf }}</td>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        @endforeach --}}
                                    {{-- </tbody> --}}
                                    <tbody>
                                        @foreach ($konfirmasimanager as $index => $item)
                                            <tr>
                                                <th scope="row">{{ $index + $konfirmasimanager->firstItem() }}</th>
